      ...
      * TRAITEMENT POUR CONVERTIR LE DELAI EN FONCTION DU SIGNE
           ...
           MOVE 'C1PAL2'      TO WS-LIEN-IN-CODE.
           MOVE WS-ACCEPT-MOT TO  WS-LIEN-IN-MOT  .
      ...
      ******************************************
       8999-STATISTIQUES-DEB.
           ...
           DISPLAY ' '.
           DISPLAY '**********************************'
           DISPLAY '* STATISTIQUES DU PROGRAMME C1PAL2'
           DISPLAY '**********************************'
           DISPLAY '                                  '
      ...
      ******************************************
       9998-FIN-NORMALE-DEB.
           DISPLAY '**********************************'
           DISPLAY '* FIN NORMALE DU PROGRAMME C1PAL2*'
           DISPLAY '**********************************'
           STOP RUN.
