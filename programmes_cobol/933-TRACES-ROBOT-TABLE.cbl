      ...
      *
       ...
       1000-ALLER-DEB.
           ADD 1 TO WS-PAS.
           EVALUATE WS-PAS
           WHEN 1 MOVE '*'  TO WS-A1
           WHEN 2 MOVE '*'  TO WS-A2
           WHEN 3 MOVE '*'  TO WS-A3
           WHEN 4 MOVE '*'  TO WS-A4
           WHEN 5 MOVE '*'  TO WS-A5
           WHEN 6 MOVE '*'  TO WS-A6
           WHEN 7 MOVE '*'  TO WS-A7
           WHEN 8 MOVE '*'  TO WS-A8
           WHEN 9 MOVE '*'  TO WS-A9
           WHEN 10 MOVE '*' TO WS-A10
           END-EVALUATE.
