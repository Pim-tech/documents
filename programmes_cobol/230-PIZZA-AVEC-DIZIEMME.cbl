      ...
      **********************************************************
       ...
       01 WS-INDIVIDUS   PIC 9999.
       01 WS-PIZZAMANGEE PIC 9999V9 VALUE 1,1.
       01 WS-RESULTAT    PIC 9999V9.
       01 WS-RESULTATE   PIC  ZZBZZ9,9.
       01 WS-DECIM       PIC V9.
       01 WS-COMMANDE    PIC 9999.
      ...
      *
       ...
       1000-PIZZA-DEB.
           ...
           MOVE WS-RESULTAT TO WS-RESULTATE.
           DISPLAY WS-RESULTAT.
           DISPLAY WS-RESULTATE.
           ACCEPT WS-INDIVIDUS.
       1000-PIZZA-FIN.
           EXIT.
      *****************************************************
